//! Database seeder binary for module: activity
//!
//! Generated by metaphor-schema. Do not edit manually.
//!
//! Run with: cargo run --bin activity-seeder
//! Or via CLI: backbone seed run --module activity
//!
...
// Import seeders
use backbone_activity::seeders::SeedActivitySeeder;
use backbone_activity::seeders::Seeder;
...
async fn main() -> Result<()> {
    ...
    println!();
    println!("Running seeders for module: activity");
    println!();

    // Register seeders in order
    let mut seeders: Vec<Box<dyn Seeder + Send + Sync>> = Vec::new();
    seeders.push(Box::new(SeedActivitySeeder::new()));
