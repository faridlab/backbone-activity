...
use super::{
    activity_handler::create_activity_routes,
};
...
pub fn configure_routes(services: HttpServices) -> Router {
    Router::new()
        // Activity routes (12 Backbone endpoints)
        .merge(create_activity_routes(services.activity))
}
...
pub mod individual {
    ...
    pub fn activity_routes(service: Arc<ActivityService>) -> Router {
